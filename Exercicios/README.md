...
O trabalho final da matéria, gerar um arquivo do tipo `jupyter-notebook`, com os resultados preliminares de um estudo de caso. Escolha pessoal (netCDF, dataframe, csv, etc.).
...
* [** Exemplos **](./Exemplos_base/Resumo.md)
